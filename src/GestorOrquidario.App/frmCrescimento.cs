...
{
    public partial class frmCrescimento : FormBase, IForm
    {
        public frmCrescimento()
        {
            InitializeComponent();
        }
        ...
        public void Bind()
        {
            IEnumerable<FlorCrescimento> obj = new BLL.Crescimentos().GetAll();
        ...
        public void Delete()
        {
            FlorCrescimento obj = (source.Current as FlorCrescimento);
            ...
            {
                bool deleted = new BLL.Crescimentos().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Crescimentos().Set((source.Current as FlorCrescimento));
