...
{
    public partial class frmGenero : FormBase, IForm
    {
        public frmGenero()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorGenero> obj = new BLL.Generos().GetAll();
        ...
        public void Delete()
        {
            FlorGenero obj = (source.Current as FlorGenero);
            ...
            {
                bool deleted = new BLL.Generos().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Generos().Set((source.Current as FlorGenero));
