...
{
    public partial class frmTipo : FormBase, IForm
    {
        public frmTipo()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorTipo> obj = new BLL.Tipos().GetAll();
        ...
        public void Delete()
        {
            FlorTipo obj = (source.Current as FlorTipo);
            ...
            {
                bool deleted = new BLL.Tipos().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Tipos().Set((source.Current as FlorTipo));
