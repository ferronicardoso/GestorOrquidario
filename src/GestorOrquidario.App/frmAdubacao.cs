...
{
    public partial class frmAdubacao : FormBase, IForm
    {
        public frmAdubacao()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorAdubacao> obj = new BLL.Adubacoes().GetAll();
        ...
        public void Delete()
        {
            FlorAdubacao obj = (source.Current as FlorAdubacao);
            ...
            {
                bool deleted = new BLL.Adubacoes().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Adubacoes().Set((source.Current as FlorAdubacao));
