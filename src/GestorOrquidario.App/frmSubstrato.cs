...
{
    public partial class frmSubstrato : FormBase, IForm
    {
        public frmSubstrato()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorSubstrato> obj = new BLL.Substrtatos().GetAll();
        ...
        public void Delete()
        {
            FlorSubstrato obj = (source.Current as FlorSubstrato);
            ...
            {
                bool deleted = new BLL.Substrtatos().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Substrtatos().Set((source.Current as FlorSubstrato));
