...
{
    public partial class frmFornecedor : FormBase, IForm
    {
        ...
        public void Bind()
        {
            IEnumerable<FlorFornecedor> obj = new BLL.Fornecedores().GetAll();
        ...
        public void Delete()
        {
            FlorFornecedor obj = (source.Current as FlorFornecedor);
            ...
            {
                bool deleted = new BLL.Fornecedores().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Fornecedores().Set((source.Current as FlorFornecedor));
