...
{
    public partial class frmLuminosidade : FormBase, IForm
    {
        public frmLuminosidade()
        {
            InitializeComponent();
        }
        ...
        public void Bind()
        {
            IEnumerable<FlorLuminosidade> obj = new BLL.Luminosidades().GetAll();
        ...
        public void Delete()
        {
            FlorLuminosidade obj = (source.Current as FlorLuminosidade);
            ...
            {
                bool deleted = new BLL.Luminosidades().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Luminosidades().Set((source.Current as FlorLuminosidade));
