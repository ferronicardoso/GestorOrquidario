...
{
    public partial class frmFloracao : FormBase, IForm
    {
        public frmFloracao()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorFloracao> obj = new BLL.Floracoes().GetAll();
        ...
        public void Delete()
        {
            FlorFloracao obj = (source.Current as FlorFloracao);
            ...
            {
                bool deleted = new BLL.Floracoes().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Floracoes().Set((source.Current as FlorFloracao));
