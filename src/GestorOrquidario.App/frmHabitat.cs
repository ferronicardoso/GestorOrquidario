...
{
    public partial class frmHabitat : FormBase, IForm
    {
        public frmHabitat()
        {
            InitializeComponent();
        ...
        public void Bind()
        {
            IEnumerable<FlorHabitat> obj = new BLL.Habitats().GetAll();
        ...
        public void Delete()
        {
            FlorHabitat obj = (source.Current as FlorHabitat);
            ...
            {
                bool deleted = new BLL.Habitats().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Habitats().Set((source.Current as FlorHabitat));
