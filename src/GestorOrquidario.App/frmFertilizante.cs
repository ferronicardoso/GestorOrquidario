...
{
    public partial class frmFertilizante : FormBase, IForm
    {
        public frmFertilizante()
        {
            InitializeComponent();
        }
        ...
        public void Bind()
        {
            IEnumerable<FlorFertilizante> obj = new BLL.Fertilizantes().GetAll();
        ...
        public void Delete()
        {
            FlorFertilizante obj = (source.Current as FlorFertilizante);
            ...
            {
                bool deleted = new BLL.Fertilizantes().Delete(obj);
        ...
        {
            grid.EndEdit();
            bool saved = new BLL.Fertilizantes().Set((source.Current as FlorFertilizante));
